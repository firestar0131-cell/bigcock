...
function Today() {
  ...
  // 本地專屬 UUID (避開未登入 anonymous-user 的型別錯誤)
  ...
  if (!isMounted) {
    return (
      <AppShell>
        <div className="flex h-64 items-center justify-center font-mono text-xs text-muted">
          載入中...
        </div>
      </AppShell>
    );
          ...
          <section className="rounded-2xl bg-card p-4 ring-1 ring-white/50 backdrop-blur-xl space-y-4">
            <div>
              ...
              <p className="text-[11px] text-muted mt-1 leading-relaxed">
                🔒 隱私安全：照片純屬個人視覺檔案，嚴禁由 AI 讀取，直接存入私密加密相簿。
              </p>
            </div>
